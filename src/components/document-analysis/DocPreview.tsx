...
export default function DocPreview({ doc }: { doc: Document | null }) {
  return (
    <div className="bg-surface border border-line rounded-2xl shadow-card-sm overflow-hidden">
      ...
      <div className="bg-[#eef0f3] p-5 h-80 flex items-center justify-center">
        {doc ? (
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <div>
              <p className="text-[15px] font-semibold text-ink m-0 mb-1 max-w-56 truncate">{doc.originalFileName}</p>
